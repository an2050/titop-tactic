...
# ========================== EXTRA ARGS ============================================
            ...
            keyPrjData = dict()
            keyPrjData["'project'"] = "'" + metaNode.knob('projectName').value() + "'"
            keyPrjData["'episod'"] = "'" + metaNode.knob('episodName').value() + "'"
            keyPrjData["'shot'"] = "'" + metaNode.knob('shotName').value() + "'"
            keyPrjData = json.dumps(keyPrjData)
# ========================== EXTRA ARGS ============================================
            cmd += ' -X %s -F@#@-@#@x%d -x \"%s\" \"%s\"' % \
                   (self.writename, self.frameinc, scenename, keyPrjData)
# =============================== END CUSTOM =========================================
