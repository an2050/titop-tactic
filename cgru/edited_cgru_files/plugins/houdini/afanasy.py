...
# ============================ Extra arguments =================================
            # prjArgs = [os.environ.get('PRJ'), os.environ.get('EPISOD'), os.environ.get('SHOT'), os.environ.get('RENDER')]
            prjArgs = [hou.hscript('echo $PRJ')[0].strip(), hou.hscript('echo $EPISOD')[0].strip(),
                       hou.hscript('echo $SHOT')[0].strip(), hou.hscript('echo $RENDER')[0].strip()]
            self.cmd += ' "{}"'.format(prjArgs)
...
# ============================ Extra arguments =================================
    ...
    def genJob(self, blockparams):
        ...
        if self.afnode.parm('render_temp_hip').eval():
            ...
            hou.hscript('setenv -l AFANASY="TRUE')
# ==============================================================================
            hou.hscript('mwrite -n "%s"' % renderhip)
# ==============================================================================
            hou.hscript('setenv -u AFANASY')
